import { sectionScore } from './engine.mjs';
...
export function mergeRecords(existing, incoming) {
  ...
  for (const candidate of [...incoming,...existing]) {
    if (!candidate || typeof candidate.id !== 'string' || candidate.id.length > 100 || !['full','noEssay','verbalOnly','quantOnly','diagnostic','custom'].includes(candidate.mode)) continue;
